...
/**
 * Classe Java per ctResponse complex type.
 *
...
@XmlType(
    name = "ctResponse",
    propOrder = {"outcome", "fault"})
@XmlSeeAlso({DemandPaymentNoticeResponse.class})
public class CtResponse {
   ...
   *
   * @return possible object is {@link CtFaultBean }
   */
   ...
   *
   * @param value allowed object is {@link CtFaultBean }
   */
