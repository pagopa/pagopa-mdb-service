...
/**
 * Classe Java per ctPaymentOptionsDescriptionList complex type.
 *
...
@XmlType(
    name = "ctPaymentOptionsDescriptionList",
    propOrder = {"paymentOptionDescription"})
@AllArgsConstructor
@NoArgsConstructor
@Data
@Builder
public class CtPaymentOptionsDescriptionList {
   ...
   * object. This is why there is not a <CODE>set</CODE> method for the paymentOptionDescription
   * property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link CtPaymentOptionDescription }
   */
